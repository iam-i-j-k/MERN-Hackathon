...
const RestaurantDashboard = () => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_APP_BACKEND_URL}/api/restaurant/profile`, {
      headers: {
  ...
  const fetchOrders = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_APP_BACKEND_URL}/api/restaurant/orders`,
        {
            headers: {
                Authorization: `Bearer ${token}`,
            },
  ...
  const updateOrderStatus = async (orderId, status) => {
    try {
      const res = await axios.put(`${import.meta.env.VITE_APP_BACKEND_URL}/api/restaurant/orders/${orderId}`,
        {
            headers: {
                Authorization: `Bearer ${token}`,
            },
